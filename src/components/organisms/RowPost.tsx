...
const RowPost: React.FC<RowPostProps> = ({ welcomeLine, productList }) => {
  return (
    <div className="flex flex-col gap-space-03 w-full">
      <div className="flex justify-between">
        <div className="text-[4vw] new-sm:text-xl text-[#ffffff] font-system-bold font-satoshi">{welcomeLine}</div>
        <div className=""><CustomButton variant="secondary" text="View All" /></div>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-space-06">
